...
`skill_level`        int(2)        DEFAULT NULL             COMMENT 'The level of the skill; 1 being worst, 10 being best',
PRIMARY KEY (`skill_id`),
FOREIGN KEY (experience_id) REFERENCES experiences(experience_id)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COMMENT="Skills that were needed";